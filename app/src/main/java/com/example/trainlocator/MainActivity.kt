...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dateChooser.setOnClickListener{
            DatePickerDialog(this@MainActivity, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
...
//                                ).show()
        ...
        book_btn.setOnClickListener {
            ...
            val call = api.userBooking(fromString,toString,classString,mDate,
                sharedPreference.getValueString("name").split(" ")[0],sharedPreference.getValueString("name").split(" ")[1],
    ...
    private fun updateDateLabel() {
        ...
        val mFormat = "yyyy-MM-dd" //In which you need put here
